    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-success" role="alert">
                <h1 class="col-12 h3 mb-0 text-gray-800">Selamat Datang <b><?= $yang_login; ?></b> di Admin Panel <br>Company Profile Leafora Agro Industri </h1>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?= $quotation; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Galery</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $galery; ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                        </div>
